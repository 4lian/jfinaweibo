	 ...
	 <td id="left">
	   <table class="detailContent">
			 ...
			 <tr class="detailspread">
			  <td height="25px">
			   <div class="official">
			    <span>分类: <a href="${ctx }">首页</a>- &gt;<a href="${ctx }/${article.curl}.html">${article.cname }</a> | 阅读: ${article.clicknum} | 评论:  ${gbookSize } | 2013-9-26 11:09:11</span>&nbsp;
			   </div>
			  </td>
			 </tr>
	   ...
	   <table class="detailInput">
	      ...
	      <tr>
			 <td>
			 <form action="${ctx }/message" method="post" id="messageForm"> 
               <div>
